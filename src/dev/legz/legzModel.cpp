...
void legzModel::addNodes(tgStructure& s, double length)
{
    ...
    s.addNode(length/8.0, length/2.0, 0);
    s.addNode(length/8.0, -length/2.0, 0);
    //2 = 1 but up same z,y 
    s.addNode(-length/8.0, length/2.0, 0);
    s.addNode(-length/8.0, -length/2.0,  0);
    ...
    s.addNode(0, length/5.0, length*2);
    s.addNode(0, length/5.0, -length*2);
    ...
    //5 parallel to y 8,3
    s.addNode(-length*1.5, 0, length/8.0);
    s.addNode(length*1.5, 0, length/8.0);
    //6 = 5 but backward and smaller 8,1
    s.addNode(-length/2.0, 0, -length/8.0);
    s.addNode(length/2.0, 0, -length/8.0);


    //7 = 6 but more backward 11/8,1
    s.addNode(-length/2.0, 0, -11*length/8.0);
    s.addNode(length/2.0, 0, -11*length/8.0);

    //8 = 1 but backward 
    s.addNode(length/8.0, length/2.0, -length);
    s.addNode(length/8.0, -length/2.0, -length);
