...
class Evaluater:
    ...
    def evaluate(self, evaluation_config, agent_config, env_config, random=False):
        ...
        trained_agent = ars.ARSTrainer(config, env="twiceCube")
    ...
    def run(self, args, parser):
        ...
        self.env_config["sim_headless"] = False
        self.evaluation_config["num_episodes"] = 1
        ...
        ray.init()
        self.evaluate(self.evaluation_config, self.agent_config, self.env_config, random=False)
