# This trained on falling then angle 3 -> ARS_jumper_687731e0_2020-02-23_09-46-47ixwo7f1h
import gym
...
tune.run(
        "ARS",
        name="train3_hp(mod_increased_rollouts)_ground_random_ang3_leg_angle_restore_train",
