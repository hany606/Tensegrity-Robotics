# This is the same as train3_mod_restore_train_random_ang3_2.py but with the modification in the library
# This training for 2 angles
...
env_config = {'observation': ['end_points', 'end_points_velocities', 'rest_length'], 'control_type': 'rest_length_mod', 'starting_coordinates':[0,10,0],  "extra_trainer_configs": {"domain_randomization":{"starting_leg_angle":{"min":[-3,-3], "max":[3,3]}}}}
...
tune.run(
        ARSTrainer,
        name="train4_ground_random_2ang3_leg_angle_restore_train_mod_lib",
