...
env_config = {'observation': ['end_points', 'end_points_velocities', 'rest_length'], 'control_type': 'rest_length_mod', 'starting_coordinates':(0,10,0), 'starting_leg_angle': (1.75,0)}
...
tune.run(
        "ARS",
        name="train3_ground_leg_angle175",
        stop={
