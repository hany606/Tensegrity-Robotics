"""jumper_env.py: Create the gym custom environment of tensegrity Jumper"""
...
#
# 9). [Done] should be easy TODO [Done] I had to write here the JumperModel as it is not installed and copied with the JumperEnv
# 10). [Done] change the name of the gym to gym-tensegrity and gym_tensegrity but the env is Jumper as it is
...
class JumperEnv(gym.Env):
    ...
    def __init__(self, host_name='localhost', port_num=10040, sim_exec=sim_exec,  dl=0.1):
        ...
        # Initial configuration for the Jumper
        # TODO [Done]:
        #   -setup the Jumper; initialization, communication, start, and set the variables
    ...
    def _takeAction(self, action):
        ...
        # # TODO [Done]: put the scheme of the actions for the Jumper [Done]
        # # TODO [Done]: test !!!
