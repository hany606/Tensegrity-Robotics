...
#ifndef TwiceCube_MODEL_H
#define TwiceCube_MODEL_H
...
/**
 * A class that constructs TwiceCube Model using the tools
 ...
 */
class TwiceCubeModel : public tgSubject<TwiceCubeModel>, public tgModel
{
public: 
