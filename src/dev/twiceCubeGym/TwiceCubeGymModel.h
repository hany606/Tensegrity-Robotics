...
#ifndef TwiceCubeGym_MODEL_H
#define TwiceCubeGym_MODEL_H

/**
 * @file TwiceCubeGymModel.h
...
/**
 * A class that constructs TwiceCubeGym Model using the tools
 ...
 */
class TwiceCubeGymModel : public tgSubject<TwiceCubeGymModel>, public tgModel
{
public: 
