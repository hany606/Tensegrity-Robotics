...
/**
 * @file TwiceCubeGymModel.cpp
 * @brief Contains the definition of the members of the class TwiceCubeGymModel.
 * $Id$
 */
...
TwiceCubeGymModel::TwiceCubeGymModel() : tgModel()
{

}

TwiceCubeGymModel::~TwiceCubeGymModel()
{
}

void TwiceCubeGymModel::addNodes(tgStructure& s)
{
    // y z x
...
void TwiceCubeGymModel::addRods(tgStructure& s)
{
    s.addPair(0, 1, "rod");
	s.addPair(1, 3, "rod");
	s.addPair(3, 2, "rod");
...
void TwiceCubeGymModel::addMuscles(tgStructure& s)
{
...
void TwiceCubeGymModel::setup(tgWorld& world)
{
...
void TwiceCubeGymModel::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void TwiceCubeGymModel::onVisit(tgModelVisitor& r)
{
    // Example: m_rod->getRigidBody()->dosomething()...
    tgModel::onVisit(r);
}

std::vector<tgBasicActuator*>& TwiceCubeGymModel::getAllActuators()
{
    return allActuators;
}

std::vector<tgRod*>& TwiceCubeGymModel::getAllRods()
{
    return allRods;
}
...
void TwiceCubeGymModel::teardown()
{
    notifyTeardown();
    tgModel::teardown();
}